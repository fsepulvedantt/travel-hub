...
import com.ntt.travelhub.reserva.service.persistence.ReservaUtil;
import com.ntt.travelhub.reserva.service.persistence.impl.constants.ReservaPersistenceConstants;
...
public class ReservaPersistenceImpl
	 ...
	 */
	@Override
	public List<Reserva> findByDni(String dni) {
		return findByDni(dni, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null);
	}
	 ...
	 */
	@Override
	public List<Reserva> findByDni(String dni, int start, int end) {
		return findByDni(dni, start, end, null);
	}
	 ...
	 */
	@Override
	public List<Reserva> findByDni(
		String dni, int start, int end,
		OrderByComparator<Reserva> orderByComparator) {

		return findByDni(dni, start, end, orderByComparator, true);
	}
	...
	public List<Reserva> findByDni(
		...
		if ((start == QueryUtil.ALL_POS) && (end == QueryUtil.ALL_POS) &&
			...
			if (useFinderCache) {
				finderPath = _finderPathWithoutPaginationFindByDni;
				finderArgs = new Object[] {dni};
			}
		}
		else if (useFinderCache) {
			finderPath = _finderPathWithPaginationFindByDni;
			finderArgs = new Object[] {dni, start, end, orderByComparator};
		}
		...
		if (list == null) {
			...
			if (dni.isEmpty()) {
				sb.append(_FINDER_COLUMN_DNI_DNI_3);
			}
			else {
				bindDni = true;

				sb.append(_FINDER_COLUMN_DNI_DNI_2);
			}
	...
	public Reserva findByDni_First(
		...
		Reserva reserva = fetchByDni_First(dni, orderByComparator);
	...
	public Reserva fetchByDni_First(
		...
		List<Reserva> list = findByDni(dni, 0, 1, orderByComparator);
	...
	public Reserva findByDni_Last(
		...
		Reserva reserva = fetchByDni_Last(dni, orderByComparator);
	...
	public Reserva fetchByDni_Last(
		...
		int count = countByDni(dni);

		if (count == 0) {
			return null;
		}

		List<Reserva> list = findByDni(
			dni, count - 1, count, orderByComparator);
	...
	public Reserva[] findByDni_PrevAndNext(
		...
		try {
			...
			array[0] = getByDni_PrevAndNext(
				session, reserva, dni, orderByComparator, true);

			array[1] = reserva;

			array[2] = getByDni_PrevAndNext(
				session, reserva, dni, orderByComparator, false);
	...
	protected Reserva getByDni_PrevAndNext(
		Session session, Reserva reserva, String dni,
		OrderByComparator<Reserva> orderByComparator, boolean previous) {
	...
	public void removeByDni(String dni) {
		for (Reserva reserva :
				findByDni(dni, QueryUtil.ALL_POS, QueryUtil.ALL_POS, null)) {
	...
	public int countByDni(String dni) {
		...
		FinderPath finderPath = _finderPathCountByDni;
	...
	private static final String _FINDER_COLUMN_DNI_DNI_2 = "reserva.dni = ?";
	...
	public Reserva create(long reservaId) {
		...
		reserva.setNew(true);
		reserva.setPrimaryKey(reservaId);
	...
	public Reserva remove(long reservaId) throws NoSuchReservaException {
		return remove((Serializable)reservaId);
	}
	...
	public Reserva findByPrimaryKey(long reservaId)
		...
		return findByPrimaryKey((Serializable)reservaId);
	}
	...
	public Reserva fetchByPrimaryKey(long reservaId) {
		return fetchByPrimaryKey((Serializable)reservaId);
	}
	...
	public void activate() {
		...
		_finderPathWithoutPaginationFindByDni = new FinderPath(
			FINDER_CLASS_NAME_LIST_WITHOUT_PAGINATION, "findByDni",
			new String[] {String.class.getName()}, new String[] {"dni"}, true);
	...
	public void deactivate() {
		ReservaUtil.setPersistence(null);
	...
	@Override
	@Reference(
		target = ReservaPersistenceConstants.SERVICE_CONFIGURATION_FILTER,
		unbind = "-"
	)
	...
	@Override
	@Reference(
		target = ReservaPersistenceConstants.ORIGIN_BUNDLE_SYMBOLIC_NAME_FILTER,
		unbind = "-"
	)
